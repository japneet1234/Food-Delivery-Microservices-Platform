...
import { FiShoppingBag, FiStar, FiSun, FiFeather } from "react-icons/fi";
...
export default function AppHome() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fff7f1] via-white to-[#f8fbff] relative overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-orange-500 via-orange-600 to-red-600 text-white py-14 mb-10 relative overflow-hidden shadow-[0_25px_60px_-25px_rgba(0,0,0,0.35)]">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-5xl mx-auto text-center space-y-4">
            <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm font-semibold backdrop-blur-sm shadow-inner shadow-white/10">
              ...
              Explore the city&apos;s finest menus
            </div>
            <h1 className="text-4xl md:text-5xl font-extrabold drop-shadow-sm">Jump back into Foodie</h1>
            <p className="text-lg md:text-xl text-orange-50/90">
              Search, filter, and track your orders in real time.
            </p>
            <div className="grid gap-4 md:grid-cols-[2fr,1fr] items-center">
              ...
              <div className="bg-white/10 border border-white/20 backdrop-blur-sm rounded-xl p-4 text-left shadow-lg">
                <p className="text-white/90 text-xs font-semibold mb-2">Track an order</p>
                <OrderTrackingInput />
              </div>
            </div>
            <div className="flex flex-wrap justify-center gap-3 pt-2 text-sm text-white/90">
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/15 flex items-center gap-2">
                <FiSun className="w-4 h-4" /> Fresh drops
              </span>
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/15 flex items-center gap-2">
                <FiFeather className="w-4 h-4" /> Light bites
              </span>
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/15 flex items-center gap-2">
      ...
      <div className="container mx-auto px-4 pb-12">
        <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            {searchQuery && (
              <p className="text-gray-600 text-sm">Showing results for "{searchQuery}"</p>
            )}
          </div>
